        ...
        <div className="dashboard-main">
          ...
          <div className="dashboard-sidebar">
            ...
            <div className="tab-buttons">
              <button onClick={handleConsultancyClick} className={`tab-button ${selectedTab === 1 ? 'active' : ''}`}>
                Consultancy {newConsultancyUpdates && <span className="notification-badge"></span>}
              </button>
              <button onClick={handleHistoryClick} className={`tab-button ${selectedTab === 2 ? 'active' : ''}`}>
                History {newHistoryUpdates && <span className="notification-badge"></span>}
              </button>
            </div>
          </div>
                ...
                {consultancyDetails && consultancyDetails.map((detail, index) => (
                  <div className="tile" key={index}>
                    <div className="consultancy-details">
                      ...
                      <button className="value-tile" onClick={() => handleValueClick()}>
                        {/* Values */}
